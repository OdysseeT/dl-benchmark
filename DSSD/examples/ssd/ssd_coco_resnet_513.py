...
def AddExtraLayers(net, use_batchnorm=True):
    ...
    # 4 x 4
    ResBody(net, 'res7', '8', out2a=256, out2b=256, out2c=1024, stride=2, kernel=2, use_branch1=True)
    # 2 x 2
    ResBody(net, 'res8', '9', out2a=256, out2b=256, out2c=1024, stride=2, kernel=2, use_branch1=True)
    # 1 x 1
    ResBody(net, 'res9', '10', out2a=256, out2b=256, out2c=1024, stride=2, kernel=2, use_branch1=True)
...
inter_layer_depth = [[128], [512], [256], [256], [256], [256], [256]]
normalizations=[]
