...
# Methods provided for combining features, 'Eltwise', 'Concat', 'EltwiseProd', 'CompactBilinear'
#deconv_combine_method='Concat'
...
job_name = "DSSD_{}".format(resize)
#job_name = "SSD_test{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "ResNet-101_coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet-101/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet-101/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet-101/coco/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "./results/coco/{}/Main".format(job_name)
...
pretrain_model = "models/ResNet-101/coco/SSD_513x513/ResNet-101_coco_SSD_513x513_iter_250000.caffemodel"
...
# res8_relu ==> 2x2
# res9_relu ==> 1x1
mbox_source_layers = ['res3b3_relu', 'res5c_relu', 'res6_relu', 'res7_relu', 'res8_relu', 'res9_relu', 'res10_relu']
# in percent %
min_ratio = 10
max_ratio = 95
...
starts = [2.5, 2.5, 10.5, 26.5, 58.5, 122.5, 256.5]
kmeans_ratios = [1.60, 2.0, 3.0]
aspect_ratios=[]
for i in range(len(mbox_source_layers)):
    aspect_ratios.append(kmeans_ratios)

inter_layer_depth = [[256], [256], [256], [256], [256], [256], [256]]
normalizations=[]
prediction_kernels= [5,5,3,3,3,3,3]
prediction_pads = [2,2,1,1,1,1,1]
conf_inter = [512, 512, 512, 512, 512, 512, 512]
...
deconv_layers = AddDeconvLayers(net, mbox_source_layers[5::-1], use_batchnorm=True)
...
mbox_layers = CreateMultiBoxOutput(net, data_layer='data',
        ...
        conf_inter=conf_inter, loc_inter=conf_inter,
